...
class PascalVOCDetectionEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        total_num_unk = num_unks[50][0]
        self._logger.info(
            "unknown num:{}, unknown recall num:{}, unknown right num:{}, detected percent:{}, correct percent:{}".format(
                total_num_unk, unknown_is_detected, unknown_pred_correct,
                float(unknown_is_detected) / total_num_unk * 100,
                float(unknown_pred_correct) / unknown_is_detected * 100))
