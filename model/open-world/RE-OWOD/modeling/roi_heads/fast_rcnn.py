...
def fast_rcnn_inference_single_image(
    ...
    #         class_scores = pickle.load(file)
    #     class_list = []
    #     class_var_list = []
    #     for class_i in (class_scores):
    #         class_num = len(class_i)
    #         if class_num == 0:
    #             class_list.append(0.0)
    #             class_var_list.append(0.0)
    #             continue
    #         per_class = torch.Tensor(class_i)
    #         # average
...
class FastRCNNOutputs:
    ...
    def box_reg_loss(self):
        ...
        fg_inds = nonzero_tuple((self.gt_classes >= 0) & (self.gt_classes < bg_class_ind))[0] # -1 ä¸�ç®—unkçš„loss
